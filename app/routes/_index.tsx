                ...
                <section className="container">
                    ...
                    <div className="mb-8 flex items-center justify-between">
                        <h4 className="wae-h4 max-w-[592px] font-secondary">
                            We are thought that becomes action. Matter that
                            transforms into emotion. Invisible yet concrete
                            values, to give a new meaning to an interior place.
                        </h4>
                        <p className="basis-60 uppercase">
                            <strong>We are thought that becomes action.</strong>{" "}
                            Matter that transforms into emotion. Invisible yet
                            concrete values,{" "}
                            <strong>
            ...
            <section className="flex flex-col items-center justify-center bg-black py-[180px] text-center text-white">
                <div className="container">
                    <div className="mx-auto mb-[180px] max-w-5xl">
                        ...
                        <h2 className="wae-h2 mb-[100px] mt-10 font-secondary leading-tight">
                            Projects created by our <br /> customers to draw
                            inspiration from
                        </h2>
                ...
                <div className="w-1/2 bg-white px-40 py-36">
                    <div className="container">
                        ...
                        <div className="my-12 max-w-[360px]">
                            ...
                            <p>
                                Stay connected with WAE Foundation. Get the
                                latest news, updates, and stories delivered
